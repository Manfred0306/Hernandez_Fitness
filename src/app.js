...
app.use('/api/auth',authRoutes); app.use('/api/mediciones',measurementRoutes); app.use('/api/entrenadores',trainerRoutes); app.use(express.static(path.join(__dirname,'../public'))); app.use(errorHandler); export default app;
